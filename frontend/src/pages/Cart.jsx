...
export const Cart = () => {
    ...
    const { products, user, currency, cartItems, removeFromCart, getCartCount, updateCartItem, navigate, getCartAmount, axios, setCartItems } = useAppContext()
                        ...
                        <div className="relative flex justify-between items-start mt-2">
                            ...
                            {showAddress && (
                                <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                    ...
                                    <p onClick={() => navigate('/add-address')} className="text-white text-center cursor-pointer p-2 hover:bg-primary-dull">
                                        Add address
                                    </p>
                                </div>
                            )}
